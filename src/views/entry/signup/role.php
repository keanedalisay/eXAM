...
class Role extends Entry
{
  public function addForm(): void
  {
    $form = <<<html
            ...
            <form class="form form--roles">
              <fieldset class="roles">
                <label class="role">
                  <input class="role-radio" type="radio" name="signup_role" value="student">
                ...
                <label class="role">
                  <input class="role-radio" type="radio" name="signup_role" value="teacher">
                  <figure class="role-icon">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
